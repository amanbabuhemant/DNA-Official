      ...
      try {
        ...
        const pdfContent: ContentItem[] = [
          ...
          },
          {
            ...
            content: 'Comprehensive guide covering Python fundamentals, data structures, OOP, and advanced topics with practical examples and exercises.',
            type: 'pdf' as const,
            status: 'published' as const,
            author_id: 'dna-team',
            author_email: 'team@dnaforge.com',
          ...
          },
          {
            ...
            content: 'Master modern JavaScript with ES6+ features, async programming, modules, and best practices for web development.',
            type: 'pdf' as const,
            status: 'published' as const,
            author_id: 'dna-team',
            author_email: 'team@dnaforge.com',
          ...
          },
          {
            ...
            content: 'Essential data structures and algorithms with time complexity analysis, implementation examples, and problem-solving strategies.',
            type: 'pdf' as const,
            status: 'published' as const,
            author_id: 'dna-team',
            author_email: 'team@dnaforge.com',
            tags: ['DSA', 'Algorithms', 'Problem Solving', 'Interview Prep'],
            featured: true,
          ...
          },
          {
            ...
            content: 'Learn React from basics to advanced concepts including hooks, context, state management, and performance optimization.',
            type: 'pdf' as const,
            status: 'published' as const,
            author_id: 'dna-team',
            author_email: 'team@dnaforge.com',
          ...
          },
          {
            ...
            content: 'Introduction to machine learning concepts, algorithms, and practical implementation using Python and popular libraries.',
            type: 'pdf' as const,
            status: 'published' as const,
            author_id: 'dna-team',
            author_email: 'team@dnaforge.com',
          ...
          },
          {
            ...
            content: 'Comprehensive guide to system design interviews covering scalability, databases, caching, and distributed systems.',
            type: 'pdf' as const,
            status: 'published' as const,
            author_id: 'dna-team',
            author_email: 'team@dnaforge.com',
          ...
          },
          {
            ...
            content: 'Complete guide to Git version control, branching strategies, collaboration workflows, and advanced Git techniques.',
            type: 'pdf' as const,
            status: 'published' as const,
            author_id: 'dna-team',
            author_email: 'team@dnaforge.com',
          ...
          },
          {
            ...
            content: 'Learn database design principles, SQL optimization techniques, and performance tuning for efficient data management.',
            type: 'pdf' as const,
            status: 'published' as const,
            author_id: 'dna-team',
            author_email: 'team@dnaforge.com',
            tags: ['SQL', 'Database', 'Optimization', 'Data Management'],
            featured: false,
          ...
          },
          {
            ...
            content: 'Get started with Amazon Web Services covering EC2, S3, Lambda, and cloud architecture best practices.',
            type: 'pdf' as const,
            status: 'published' as const,
            author_id: 'dna-team',
            author_email: 'team@dnaforge.com',
          ...
          },
          {
            ...
            content: 'Essential cybersecurity concepts, threat analysis, security protocols, and protection strategies for developers.',
            type: 'pdf' as const,
            status: 'published' as const,
            author_id: 'dna-team',
            author_email: 'team@dnaforge.com',
            tags: ['Cybersecurity', 'Security', 'Protocols', 'Best Practices'],
            featured: false,
