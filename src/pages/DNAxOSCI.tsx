          ...
          <div className="text-center">
            <div className="glass-card p-12 rounded-2xl border border-green-400/30">
              ...
              <div className="flex flex-col sm:flex-row gap-8 justify-center items-center">
                <Button
                  className="bg-gradient-to-r from-green-400 to-cyan-400 text-black hover:from-green-500 hover:to-cyan-500 px-12 py-5 text-xl font-bold rounded-full shadow-xl shadow-green-400/40 hover:shadow-green-400/60 hover:scale-105 transition-all duration-300 transform"
                  onClick={() => {
                    window.open("https://docs.google.com/forms/d/1ANU3JcofxzfgIHEoKYxchJVPu8mBunTrf7VGuAQBKaY/viewform", "_blank");
                  }}
                >
                  🚀 Join OSCI Partnership
                </Button>
